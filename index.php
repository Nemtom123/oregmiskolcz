...
<head>
    ...
    <meta name="description" content="Öreg Miskolcz Hotel & Étterem">
...
<!-- Body -->
<!--========== HEADER ==========-->
<header class="navbar-fixed-top s-header js__header-sticky js__header-overlay" style="background: rgba(184, 134, 11, 0.5);" >
    <!-- Navbar -->
    <div class="s-header__navbar"> <!-- style.css 1615 color-->
                ...
                <div class="s-header__navbar-row-col">
                    ...
                    <div class="s-header__logo" >
                        <a href="index.php" class="s-header__logo-link">
                            <img class="s-header__logo-img s-header__logo-img-default" src="img/logo2.jpg" alt="Öreg Miskolcz Hotel & Étterem Logo">
                            <img class="s-header__logo-img s-header__logo-img-shrink" src="img/logo1.jpg" alt="Öreg Miskolcz Hotel & Étterem Logo">
                        </a>
                    </div>
                    <!-- End Logo -->
    ...
    <div class="s-header-bg-overlay js__bg-overlay">
        ...
        <nav class="s-header__nav js__scrollbar">
            <div class="container-fluid">
                ...
                <ul class="list-unstyled s-header__nav-menu">
                    ...
                    <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="#">App Landing</a></li>
                    <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="#">Portfolio</a></li>
                    <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="#">Events</a></li>
                    <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="#">Lawyer</a></li>
                    <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="#">Clinic</a></li>
                    <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="#">Coming Soon</a></li>
                </ul>
                <!-- End Menu List -->
        ...
        <ul class="list-inline s-header__action s-header__action--lb">
            <li class="s-header__action-item"><a class="s-header__action-link -is-active" href="#">Hu</a></li>
            <li class="s-header__action-item"><a class="s-header__action-link" href="#">En</a></li>
...
<div class="s-swiper js__swiper-one-item">
    ...
    <div class="swiper-wrapper">
        <div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('img/1920x1080/oegmiskolcz1.jpg');">
            <div class="container g-text-center--xs g-ver-center--xs">
                <div class="g-margin-b-30--xs">
                    <h1 class="g-font-size-16--xs g-font-size-12--sm g-font-size-26--md g-color--white">Legyen a Vendégünk!</h1>
                </div>
                <a class="js__popup__youtube" href="https://www.youtube.com/watch?v=aXq2hyvsSYY" title="Intro Video">
                    <i class="s-icon s-icon--lg s-icon--white-bg g-radius--circle ti-control-play"></i>
                </a>
            </div>
        </div>
        <div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('img/1920x1080/oegmiskolcz2.jpg');">
            <div class="container g-text-center--xs g-ver-center--xs">
                <div class="g-margin-b-30--xs">
                    <div class="g-margin-b-30--xs">
                        <h2 class="g-font-size-35--xs g-font-size-45--sm g-font-size-55--md g-color--white">Az Öreg Miskolcz Hotel és Étterem a történelmi belváros szívében.<br></h2>
                    </div>
                    <a class="js__popup__youtube" href="https://www.youtube.com/watch?v=UDVtMYqUAyw" title="Intro Video">
                        <i class="s-icon s-icon--lg s-icon--white-bg g-radius--circle ti-control-play"></i>
                    </a>
                </div>
            </div>
        </div>
        <div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('img/1920x1080/oegmiskolcz3.jpg');">
            <div class="container g-text-center--xs g-ver-center--xs">
                <div class="g-margin-b-30--xs">
                    <h1 class="g-font-size-35--xs g-font-size-45--sm g-font-size-55--md g-color--white">A szálloda artdecos stílusa harmonikusan illeszkedik a környező épületek múlt századbeli hangulatába</h1>
                </div>
                <a class="js__popup__youtube" href="https://www.youtube.com/watch?v=lPuK38ZCzUY" title="Intro Video">
                    <i class="s-icon s-icon--lg s-icon--white-bg g-radius--circle ti-control-play"></i>
                </a>
            </div>
        </div>
    ...
    <a href="#js__scroll-to-section" class="s-scroll-to-section-v1--bc g-margin-b-15--xs">
        ...
        <p class="text-uppercase g-font-size-26--xs g-color--white g-letter-spacing--3 g-margin-b-0--xs">Tudj meg többet róllunk</p>
    </a>
</div>
...
<div id="js__scroll-to-section" class="container g-padding-y-80--xs g-padding-y-125--sm">
    <div class="g-text-center--xs g-margin-b-100--xs">
        <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-25--xs">Üdvözlöm az oldalunkon</p>
        <h2 class="g-font-size-32--xs g-font-size-36--md">Úton lenni nem mindig az élet, néha meg is kell érkezni.</h2>
    </div>
...
<script>(() => {
        ...
        const handler = () => {
            ...
            if (newOffset > bannerHeight) {
                ...
                banner.style.background = 'rgba(255, 0, 0, 0.6)';
                refOffset = newOffset;
            } else {
                banner.style.backgroundColor = 'rgba(255, 0, 0, 1)';
            }
        };
